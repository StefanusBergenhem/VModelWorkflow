...
- **Output placement.** `specs/needs.md`, per stakeholder call (2026-05-01). See `dogfood_findings.md` Issue 1 for the framework gap that motivated the explicit decision.
