...
- `.vmodel/references/authoring-discipline.md` — 9 cross-cutting rules (product-shape, layering, compression) — applies to all review checks (resolved via `.vmodel/config.yaml`)
