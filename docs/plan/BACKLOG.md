...
*Last updated: 2026-05-09 (Phase 6 Cluster 4 closed: TARGET §5.3/§5.4/§5.5/§5.7 convention pin-downs + partial-parent-protocol canonical doc with verbatim sync into 5 author skills + 3 new mechanical scripts; resolves Issues 1/6/12/14/17/18 plus Issue 9 folded in from Cluster 6. Cluster 5 next; Cluster 6 minus Issue 9 after.).*
